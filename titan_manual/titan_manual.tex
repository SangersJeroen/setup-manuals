...
The ronchigram is the infinite magnification of the probe's interaction with an amorphous substrate and is used for rough alignment in STEM mode. Final alignment should be done with the STEM scan image.
...
\subsection*{Rotation Center (Focus) [Direct Alignment]}

\subsection*{Rotation Center (Intensity) [Direct Alignment]}
